    ...
    def __init__(self, args):
        ...
        if self.dataset_train_name == 'LSUN':
            ...
            self.dataset_train = datasets.Featarray(
                self.args.input_filename_train,
                self.args.label_filename_train,
                self.args.if_norm,
                self.args.num_images, self.args.in_dims,
                )
            ...
            self.dataset_train = datasets.ClassPairDataLoader(
                self.args.input_filename_train,
                self.args.if_norm,
                self.args.batch_imposter_image,
                self.args.batch_genuine_image,
                )

        elif self.dataset_train_name == 'ClassPairDataLoader_LabelList':
            self.dataset_train = datasets.ClassPairDataLoader_LabelList(
                self.args.input_filename_train,
                self.args.label_filename_train,
                self.args.if_norm,
                self.args.batch_imposter_image,
