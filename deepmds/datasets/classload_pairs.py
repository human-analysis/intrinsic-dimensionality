# The function of the loader is the same as that of "classpairs_labellist.py"
# The only difference is:
# the label information is from the folder where each feature vector file belongs to.
...
class ClassPairDataLoader(data.Dataset):
    def __init__(self, datafolder, if_norm, 
        batch_imposter_image, batch_genuine_image):
        self.batch_imposter_image = batch_imposter_image
        self.batch_genuine_image = batch_genuine_image
